          ...
          },
          {
            bool: {
              should: [
                ...
                {
                  wildcard: {
                    ttl: { value: "Vegetable*", case_insensitive: true },
                  },
                },
              ],
            },
              ...
              clauses: [
                {
                  span_multi: {
                    match: {
                      wildcard: {
                        ttl: { value: "A*", case_insensitive: true },
                      },
                    },
                  },
                },
              ...
              clauses: [
                { span_term: { ttl: "c" } },
                {
                  span_multi: {
                    match: {
                      wildcard: {
                        ttl: { value: "engine*", case_insensitive: true },
                      },
                    },
                  },
                },
                    ...
                    clauses: [
                      { span_term: { ttl: "wheel" } },
                      {
                        span_multi: {
                          match: {
                            wildcard: {
                              ttl: { value: "loader*", case_insensitive: true },
                            },
                          },
                        },
                      },
